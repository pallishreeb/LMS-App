...
import AudioTrack from 'react-native-video';
import OnAudioTracksData from 'react-native-video';
import OnTextTracksData from 'react-native-video';
import OnVideoAspectRatioData from 'react-native-video';
import TextTrack from 'react-native-video';
import OnAudioFocusChangedData from 'react-native-video';
import OnVideoErrorData from 'react-native-video';
import VideoRef from 'react-native-video';
import VideoDecoderProperties from 'react-native-video';
import SelectedTrack from 'react-native-video';
import OnTextTrackDataChangedData from 'react-native-video';
